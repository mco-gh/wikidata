...
DST_BASE=gs://$BUCKET
SRC_DATA_PATH=enwiki/latest/enwiki-latest-pages-articles.xml.bz2    
...
# Get name and size of latest articles file on website.
read SFILE SSIZE \
...
# Get name and size of latest articles file copy we have in Cloud Storage.
read DFILE DSIZE \
